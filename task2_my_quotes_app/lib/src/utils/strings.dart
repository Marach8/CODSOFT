...
const shareQuoteString = 'Share Quote';
...
const quoteAlreadySaved = 'Quote Already Saved!';
const noSavedQuotes = 'Oops! You currently have no saved quotes to display...';
const tempQuoteKey = 'temporaryQuote';
const noQuoteToSave = 'No Quote To Save!';
const quoteFrom = 'A nice quote from ';
const quoteShared = 'You shared a quote with a friend😍';
const emptyString = '';
const dashString = '  -- ';